...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Zap, User, Phone, X } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8 relative">
        {/* Back Arrow */}
        <Link href="/account" className="absolute top-6 left-6 text-gray-600 hover:text-gray-800">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          {/* Confirm Password Input - Only show if password has value */}
          {password && (
            <div className="mb-6">
